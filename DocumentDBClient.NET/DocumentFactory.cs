...
{
    public class DocumentFactory<TEntity> where TEntity : IBaseEntity
    {
        #region Constructor
        ...
        public DocumentFactory(IConfiguration configuration, string collectionName)
        {
        ...
        public IDocument<TEntity> CreateInstance()
        {
        ...
        public IDocument<TEntity> CreateInstance(string connectionStringKey)
        {
